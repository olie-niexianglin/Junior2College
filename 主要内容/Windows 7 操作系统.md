...
<span style="color:green;font-weight:bold;">☆☆☆图标包含系统图标、文件及文件夹图标和快捷方式图标。系统图标指“计算机”、“回 收站”、“控制面板”和“网络”的图标。快捷方式图标的左下角有一个箭头。</span>
...
<span style="color:green;font-weight:bold;">☆☆☆操作系统的中央控制区域。</span>
